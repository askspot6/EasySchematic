...
export const templates: DeviceTemplate[] = [
  ...
  // Note: Transmitters are battery-powered handheld/bodypack units — no AC port.
  // Band suffix omitted — that's a purchasing decision, not a system design one.

  {
    id: "shure-ulxd2",
    deviceType: "microphone",
    label: "ULXD2 Handheld",
    shortName: "ULXD2",
    manufacturer: "Shure",
    modelNumber: "ULXD2",
    searchTerms: ["shure", "ulxd2", "ulx-d", "wireless", "transmitter", "handheld", "vocal", "digital"],
    weightKg: 0.34,
    referenceUrl: "https://www.shure.com/en-US/products/wireless-systems/ulx-d_digital_wireless/ulxd2",
    ports: [],
  },

  {
    id: "shure-ulxd1",
    deviceType: "microphone",
    label: "ULXD1 Bodypack",
    shortName: "ULXD1",
    manufacturer: "Shure",
    modelNumber: "ULXD1",
    searchTerms: ["shure", "ulxd1", "ulx-d", "wireless", "transmitter", "bodypack", "lavalier", "headset", "digital"],
    weightKg: 0.12,
    referenceUrl: "https://www.shure.com/en-US/products/wireless-systems/ulx-d_digital_wireless/ulxd1",
    ports: [
      port("TA4F (Mini-XLR) Mic Input", "analog-audio", "input", "mini-xlr"),
    ],
  },

  {
    id: "shure-slxd2",
    deviceType: "microphone",
    label: "SLXD2 Handheld",
    shortName: "SLXD2",
    manufacturer: "Shure",
    modelNumber: "SLXD2",
    searchTerms: ["shure", "slxd2", "slx-d", "wireless", "transmitter", "handheld", "vocal", "digital"],
    weightKg: 0.28,
    referenceUrl: "https://www.shure.com/en-US/products/wireless-systems/slx-d/slxd2",
    ports: [],
  },

  {
    id: "shure-slxd1",
    deviceType: "microphone",
    label: "SLXD1 Bodypack",
    shortName: "SLXD1",
    manufacturer: "Shure",
    modelNumber: "SLXD1",
    searchTerms: ["shure", "slxd1", "slx-d", "wireless", "transmitter", "bodypack", "lavalier", "headset", "digital"],
    weightKg: 0.1,
    referenceUrl: "https://www.shure.com/en-US/products/wireless-systems/slx-d/slxd1",
    ports: [
      port("TA4F (Mini-XLR) Mic Input", "analog-audio", "input", "mini-xlr"),
    ],
  },

  {
    ...
    manufacturer: "Shure",
    modelNumber: "AD2",
    searchTerms: ["shure", "ad2", "axient", "axient digital", "wireless", "transmitter", "handheld", "vocal", "digital", "high density"],
    weightKg: 0.35,
    referenceUrl: "https://www.shure.com/en-US/products/wireless-systems/axient_digital/ad2",
    ports: [],
  },

  {
    ...
    manufacturer: "Shure",
    modelNumber: "AD1",
    searchTerms: ["shure", "ad1", "axient", "axient digital", "wireless", "transmitter", "bodypack", "lavalier", "headset", "digital"],
    weightKg: 0.12,
    referenceUrl: "https://www.shure.com/en-US/products/wireless-systems/axient_digital/ad1",
    ports: [
      port("TA4F (Mini-XLR) Mic Input", "analog-audio", "input", "mini-xlr"),
    ],
  },
